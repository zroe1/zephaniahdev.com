...
const Menu = (props) => {
  ...
  return (
    <div>
      ...
      {isPortfolioSelected && menuPage == 0 && (
        <div className="menu-container">
          <PortfolioItem
            animationNum="animationFirst"
            itemName={"tinyfilter"}
      ...
      {isPortfolioSelected && menuPage == 1 && (
        <div className="menu-container">
          <PortfolioItem
            animationNum="animationFirst"
            itemName={"MIT 6.S191"}
      ...
      {isPortfolioSelected && menuPage == 2 && (
        <div className="menu-container">
          <PortfolioItem
            animationNum="animationFirst"
      ...
      {isPortfolioSelected && menuPage == 3 && (
        <div className="menu-container">
          <PortfolioItem
            animationNum="animationFirst"
