...
function Box({ color, rotation }) {
  ...
  if (window.innerWidth < 600) {
    meshArgs = [2.0, 0.6, 16, 100];
  } else {
    meshArgs = [2.2, 0.7, 16, 100];
  }
...
export default function LegacyApp() {
  ...
  // This windowHeight piece of state and UseEffect were generated by GTP-4 so I
  // am keeping the somewhat unnecessary comments for self-reference
  ...
  return (
    <div className="root-container" style={backgroundStyle}>
      ...
      <ColorSelectors
        color={TextColor}
        handleBackgroundChange={setBackground}
        handleShapeChange={setShape}
        handleTextChange={setText}
      />
      {ShapeRotation == 0 && <CenterText color={TextColor} handleRotationChange={setRotation} />}
      {ShapeRotation != 0 && (
        <>
          <Menu menuBackground={ShapeColor} textColor={TextColor} />{" "}
          <ReturnToHomeBtn handleGoHome={goHome} />
        </>
      )}
      <Canvas>
        <OrbitControls />
